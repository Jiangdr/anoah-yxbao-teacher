  ...
  <transition name='fade'>
    <div
      ...
      <div class='aimtooldiv clear-fix'>
        ...
        <div class='aimclosediv fr' v-on:click.stop='closeclick'><span class="math-icon">&#xe628;</span></div>
      </div>
...
<script>
  ...
  const keysTextJson = require('./json/keystext.json'),
    pyinput = require('./pyinput.json');
  ...
  export default {
    ...
    methods: {
      ...
      btnClick(e, {expect, text, type, isUpper = false, view}) {
        ...
        /*点击下一空*/
        if (expect === 'next' && boardType !== 'combo') {
          this.pinyinstr = '';
        ...
        if (boardType === 'combo') {
          if (expect === 'languageSwitch') {
            ...
            this.boardType = 'comboNumber';
            return
          }
          if (boardModel === 'text') {
            ['next'].includes(expect) && (text = 'enter');
          }
        }
        ...
        if (boardType === 'comboNumber') {
          ['next'].includes(expect) && (text = 'enter');
        }

        if (expect && expect.match(/{\S*}\^{\S*}/igm)) {
          console.log(expect, view, text);
        ...
        /*特殊按键*/
        if (['delete', 'fraction', 'enter', 'space', "sqrt2", "sqrt3", "aimsup", "aimsub", 'σ^2'].includes(expect)) {
          text = expect;
        }
      ...
      changemainscroll: function (target) {
        if (!target) return;
        if (this.vthis.rootdata.imshow == 1) {
          this.vthis.$nextTick(() => {
  ...
  */
      ...
      insertstr: function (array, index, str, name = 'aime', view) {
        ...
        array.splice(index, 0, {name, value: str, view});
      },
      //查找公式数组里的光标的位置并插入字符
      findfraccurinsert: function (name, str, frac_ele, other_ele, view = str) {
        ...
        if (k >= 0) {
          if (
            ...
            this.insertstr(frac_ele, k, str, 'aime', view);
          }
        }
        return 0;
      },
...
<style lang='scss' scoped>
  ...
  .anoahimdiv {
    font-family: "customFont", "Microsoft YaHei", "sans serif", "Tahoma", "Helvetica", "Arial", "math-icon";
...
<style lang="scss">
  ...
  /*符号字体*/
  @font-face {
    font-family: 'math-icon';  /* project id 681161 */
    src: url('//at.alicdn.com/t/font_681161_lknr97w91hxe0zfr.eot');
    src: url('//at.alicdn.com/t/font_681161_lknr97w91hxe0zfr.eot?#iefix') format('embedded-opentype'),
    url('//at.alicdn.com/t/font_681161_lknr97w91hxe0zfr.woff') format('woff'),
    url('//at.alicdn.com/t/font_681161_lknr97w91hxe0zfr.ttf') format('truetype'),
    url('//at.alicdn.com/t/font_681161_lknr97w91hxe0zfr.svg#iconfont') format('svg');
  }

  /*符号字体*/
  @font-face {
    font-family: 'customFont';  /* project id 681161 */
    /*src: url('//at.alicdn.com/t/font_681161_lknr97w91hxe0zfr.eot');*/
    /*src: url('//at.alicdn.com/t/font_681161_lknr97w91hxe0zfr.eot?#iefix') format('embedded-opentype'),*/
    /*url('//at.alicdn.com/t/font_681161_lknr97w91hxe0zfr.woff') format('woff'),*/
    /*url('../') format('truetype');*/
  ...
  .math-icon {
    font-family: arial, "customFont", "Microsoft YaHei", "sans serif", "math-icon";
    /*font-size: 4vh;*/
  }
  ...
  .k-btn-wrap {
    ...
    .k-btn {
      ...
      &.delete {
        background: url("images/calcdel_pc.png") no-repeat scroll center center #e8ebee;
        font-size: 0;
      }
      &.fraction {
        background: url("images/fraction_pc.png") no-repeat scroll center center #e8ebee;
        font-size: 0;
      }
      &.space {
      ...
      &.sqrt2 {
        background: url("images/sqrt2.png") no-repeat scroll center center #e8ebee;
        font-size: 0;
      }
      &.sqrt3 {
      ...
      &.aimsup {
        background: url("images/aimsup.png") no-repeat scroll center center #e8ebee;
        font-size: 0;
      }
      &.aimsub {
        background: url("images/aimsub.png") no-repeat scroll center center #e8ebee;
        font-size: 0;
      }
